          ...
          <div className='img-container rounded'>
            {
                ...
                : <img src={data.image || ""} className={data.image ? "img" : "no-img"} alt={data.image ? "" : "no hay imagen"}/>
            }
          </div>
          <div className="plate-detail card-body">
              <h5 className="card-title h6 rounded-top">{data.title.slice(0,30) + "..."}</h5>
              <p className="card-text rounded-bottom">{data.summary.slice(0,50) + "..."}</p>
              {
                data.vacio 
                ? null
                : <>
