                            ...
                            <div className='px-3'>
                                <div className='row m-auto w-100'>
                                    ...
                                    }
                                    {
                                        data.servings
                                        ?   <div className='col-6 col-sm-4 col-lg  container-icon p-3'>
                                                <svg width={"2em"} className='icon rounded' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M288 130.54V112h16c8.84 0 16-7.16 16-16V80c0-8.84-7.16-16-16-16h-96c-8.84 0-16 7.16-16 16v16c0 8.84 7.16 16 16 16h16v18.54C115.49 146.11 32 239.18 32 352h448c0-112.82-83.49-205.89-192-221.46zM496 384H16c-8.84 0-16 7.16-16 16v32c0 8.84 7.16 16 16 16h480c8.84 0 16-7.16 16-16v-32c0-8.84-7.16-16-16-16z"/></svg>
                                                <span className='title'>Servings: {data.servings}</span>
                                            </div>
                                        :   null   
                                    }
                                </div>
